...
public final class UpdateRoleColorUseCase {

    private final ProjectRepository repository;

    public UpdateRoleColorUseCase(ProjectRepository repository) {
        this.repository = Objects.requireNonNull(repository);
    }

    public Role execute(UUID actor, String projectId, UUID roleId, int color) {
        ...
        Role updated = original.withColor(color);
