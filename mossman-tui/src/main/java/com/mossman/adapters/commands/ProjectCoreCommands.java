...
class ProjectCoreCommands {
    ...
    private static int listProjects(CommandContext<ServerCommandSource> context) {
        ...
        var allProjects = MossManApi.getProjectRepository().findAll(0, Integer.MAX_VALUE);
    ...
    private static int createProject(CommandContext<ServerCommandSource> context) {
        ...
        if (MossManApi.getProjectRepository().findAll(0, Integer.MAX_VALUE).stream().anyMatch(p -> p.getTicketPrefix().equalsIgnoreCase(prefix))) {
        ...
        try {
            ...
            MossManApi.getCreateProjectUseCase().execute(projectBuilder, creatorId, creatorName);
    ...
    private static int deleteProject(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            MossManApi.getProjectRepository().delete(project.getId());
    ...
    private static int updateProject(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            MossManApi.getUpdateProjectUseCase().execute(project.getId(), rId, patch);
