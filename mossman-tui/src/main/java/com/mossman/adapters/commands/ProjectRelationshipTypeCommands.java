...
class ProjectRelationshipTypeCommands {
    ...
    private static int updateRelationshipType(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            MossManApi.getUpdateProjectRelationshipTypesUseCase().execute(project.getId(), rId, newLists);
    ...
    private static int removeRelationshipType(CommandContext<ServerCommandSource> context) {
        ...
        var allTickets = MossManApi.getTicketRepository().findByProjectId(project.getId(), 0, Integer.MAX_VALUE);
        var relRepo = MossManApi.getTicketRelationshipRepository();
