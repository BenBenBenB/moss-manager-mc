...
public class SettingsCommand {
    ...
    private static int viewSettings(CommandContext<ServerCommandSource> context) {
        ...
        var settings = com.mossman.MossManApi.getPlayerSettingsRepository().findByPlayerId(playerId);
    ...
    private static int setTimezone(CommandContext<ServerCommandSource> context) {
        ...
        com.mossman.MossManApi.getPlayerSettingsRepository().save(new PlayerSettings(playerId, zone.getId()));
